...
class TestHashTable(TestCase):
    ...
    def test_add_with_no_available_space_resizes(self):
        ...
        self.hash_table.add("test_key_5", f"Value_5")
    ...
    def test_value_is_replaced_when_key_exists(self):
        ...
        self.hash_table["test_key"] = "new value"
        self.assertEqual("new value", self.hash_table["test_key"])
    ...
    def test_get_with_not_existing_key_wurh_default_value(self):
        self.hash_table.add("test_key", "value")
